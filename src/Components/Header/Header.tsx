		...
		return (
            <div id='header'>
                <div onClick={() => {
                    ...
                    <img id='logo_left' className={'show'} src='assets/interface/logo_left.png' draggable='false' />
                    <img id='logo_right' className={'show'} src='assets/interface/logo_right.png' draggable='false' />
                ...
                <div onClick={() => {
                    ...
                    <img id='information_left' className={this.props.currentPage === 'Portfolio' || this.props.currentPage === 'Welcome' ? 'show' : ''} src='assets/interface/information_left.png' draggable='false' />
                    <img id='information_right' className={this.props.currentPage === 'Portfolio' || this.props.currentPage === 'Welcome' ? 'show' : ''} src='assets/interface/information_right.png' draggable='false' />
